                    ...
                    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-alt">
                            ...
                            <li class="breadcrumb-item" aria-current="page">
                                <a class="link-fx" href="">All Sub Categories</a>
                            </li>
                        </ol>
                    </nav>
                </div>
    ...
    <script>
        $(function() {
                ...
                columns: [
                    { data: 'icon', name: 'icon',
                        render: function( data, type, full, meta ) {
                            return "<img src=\"/uploads/admin/sub_categories/" + data + "\" height=\"40\"/>";
                        }
                    },
                    {
            ...
            $("#btn-create").on("click", function(e) {
                ...
                $("#head_text").html('Add Sub Category');

                var form = $("#form-create");
                form.attr("action", route('subcategories.store'));
            ...
            dtable.on('click', '.dt-btn-edit', function(e) {
                ...
                $("#showImg").attr("src",'/uploads/admin/sub_categories/' + data.icon);

                var form = $("#form-create");
                form.attr("action", route('subcategories.update', data.id));
