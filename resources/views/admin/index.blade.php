                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless table-striped table-vcenter">
                            ...
                            <tr>
                                ...
                                <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted">29 min ago</td>
                                <td class="d-none d-xl-table-cell font-size-sm">
                                    <a class="font-w600" href="javascript:void(0)">Sara Fields</a>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted">25 min ago</td>
                                <td class="d-none d-xl-table-cell font-size-sm">
                            ...
                            <tr>
                                ...
                                <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted">5 min ago</td>
                                <td class="d-none d-xl-table-cell font-size-sm">
                                ...
                                <td class="d-none d-sm-table-cell text-center">
                                    <span class="font-size-sm font-w600 px-2 py-1 rounded bg-body-dark">16%</span>
                                </td>
                                <td class="d-none d-sm-table-cell text-right font-size-sm">
                                    <strong>$949,11</strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-center font-size-sm">
                            ...
                            <tr>
                                ...
                                <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted">20 min ago</td>
                                <td class="d-none d-xl-table-cell font-size-sm">
                                ...
                                <td class="d-none d-sm-table-cell text-center">
                                    <span class="font-size-sm font-w600 px-2 py-1 rounded bg-body-dark">11%</span>
                                </td>
                                <td class="d-none d-sm-table-cell text-right font-size-sm">
                                    <strong>$27,40</strong>
                                </td>
