...
$.extend($.easing, {
    ...
    (Wolmart.$window = t(window)),
      ...
      (Wolmart.setCookie = function (t, e, a) {
        ...
        i.setTime(i.getTime() + 24 * a * 60 * 60 * 1e3),
          (document.cookie =
            t + '=' + e + ';expires=' + i.toUTCString() + ';path=/');
      }),
      ...
      (Wolmart.appear = function (e, a, i) {
        return (
          i &&
            ...
            t.extend(intersectionObserverOptions, i),
        ...
        Wolmart.$body
          .on('click', '.tab .nav-link', function (e) {
            ...
            if ((e.preventDefault(), !a.hasClass('active'))) {
              var i = t(a.attr('href'));
              i.siblings('.active').removeClass('in active'),
      ...
      (Wolmart.stickyContent = (function () {
        ...
        function i(t) {
          (t && !Wolmart.windowResized(t.timeStamp)) ||
            (Wolmart.$window.trigger('sticky_refresh_size.wolmart'), a());
        }
        return (
              ...
              i > this.top && this.isWrap
                ? ((this.height = o[0].offsetHeight),
                  ...
                  this.options.scrollMode
                    ? ((this.scrollPos >= i && o.hasClass('fix-top')) ||
                      (this.scrollPos <= i && o.hasClass('fix-bottom'))
                        ? (o.addClass('fixed'),
                          this.onFixed && this.onFixed(),
                          o.hasClass('product-sticky-content') &&
                            t('body').addClass('addtocart-fixed'))
                        : (o
                            .removeClass('fixed')
                            .css('margin-top', '')
                            .css('margin-bottom', ''),
                  ...
                  o.is('.fixed.fix-top')
                    ? ((a.offsetTop += o[0].offsetHeight),
                      (Wolmart.sticky_top_height = a.offsetTop))
                    : o.is('.fixed.fix-bottom') &&
          ...
          Wolmart.$('.floating-item').each(function (e) {
            ...
            a.data('parallax') &&
              ...
              a
                .children()
                .addClass('layer')
                .attr('data-depth', a.attr('data-child-depth')),
              a.parallax(a.data('options'));
          });
      }),
      ...
      (Wolmart.ratingTooltip = function (t) {
        for (
          ...
          e[o].addEventListener('mouseover', i),
            e[o].addEventListener('touchstart', i, { passive: !0 });
      }),
        ...
        Wolmart.$(e).each(function () {
          ...
          -1 != a.indexOf('%')
            ...
            : -1 != a.indexOf('/') &&
              (i =
                (i =
                  (parseInt(a.split('/')[0]) / parseInt(a.split('/')[1])) * 100)
                  .toFixed(2)
                  .toString() + '%'),
            e.find('span').css('width', i);
        });
      }),
          ...
          !t('.sticky-sidebar > .filter-actions').length &&
            ...
            t('.sticky-content.fix-top').each(function (e) {
              if (!t(this).hasClass('sticky-toolbox')) {
                ...
                (a += t(this).addClass('fixed').outerHeight()),
                  i || t(this).removeClass('fixed');
              }
            }),
            Wolmart.$(e).each(function () {
              var e = t(this);
        ...
        }),
        {
          init: function () {
            ...
            (a.className = 'minipopup-area'),
              Wolmart.byClass('page-wrapper')[0].appendChild(a),
              (e = t(a)),
              ...
              p.on('load', function () {
                (a += c[0].offsetHeight + d.space),
                  ...
                  c.offset().top - window.pageYOffset < 0 &&
                    (d.close(), c.css('top', -a + c[0].offsetHeight + d.space)),
                  c
        ...
        initCategoryMenu: function () {
          ...
          if (e.length) {
            ...
            if (a.length) {
              ...
              (window.pageYOffset <= i || window.innerWidth < 992) &&
                e.removeClass('show'),
  ...
  (function (t) {
    var e = function (t) {
        ...
        if (
          ...
          for (var a = this.children, i = a.length, o = 0; o < i; ++o)
      ...
      i = function (e) {
        ...
        a.find('.owl-item:not(.active) video').each(function () {
          this.paused || a.trigger('play.owl.autoplay'),
            this.pause(),
            (this.currentTime = 0);
        }),
          i.length &&
              ...
              var r = Wolmart.requestTimeout(
                function () {
                  e.css('transition-property', ''),
                    ...
                    a.timers.splice(a.timers.indexOf(r), 1);
                },
                n
                  ? 1e3 * Number(n.slice(0, -1)) + 500 * Number(o.slice(0, -1))
      ...
      (Slider.zoomImageRefresh = function () {
        this.$element.find('img').each(function () {
          ...
          if (t.fn.zoom) {
            ...
            void 0 !== a
              ? a.refresh()
              : ((Wolmart.zoomImageOptions.zoomContainer = e.parent()),
                e.zoom(Wolmart.zoomImageOptions));
          }
        });
      }),
      ...
      (Slider.prototype.init = function (l, c) {
        ...
        if (
          ...
          l
            ...
            .on('translated.owl.carousel', i),
          l.hasClass('animation-slider') &&
            l
              .on('initialized.owl.carousel', o)
              .on('resized.owl.carousel', n)
          ...
          p.find('a').on('click', function (e) {
            ...
            if (!a.hasClass('active')) {
              var i = a.index();
              p.parent().find('.owl-carousel').trigger('to.owl.carousel', [i]),
    ...
    (Sidebar.prototype.init = function (a) {
      ...
      return (
        ...
        i.$sidebar.length &&
          ...
          i.isNavigation &&
            ((e = e.bind(this)), Wolmart.$window.on('resize', e)),
          Wolmart.$window.on('resize', function () {
      ...
      (Sidebar.prototype.toggle = function () {
        ...
        if (window.innerWidth >= 992 && e.$sidebar.hasClass('sidebar-fixed')) {
          ...
          if (
            ...
            i.length &&
              i.hasClass('product-lists') &&
              i.toggleClass('row cols-xl-2', !a);
          }
        } else
          e.$sidebar
            .find('.sidebar-overlay .sidebar-close')
          ...
          (function () {
            ...
            function o() {
              i
                ...
                i.find('.compare-count').length > 1 &&
                  i.find('p:last-child').remove();
            }
            i.length ||
        ...
        t('.product:not(.product-single) .product-variations > a').on(
          ...
          function (e) {
            ...
            i.data('image-src') || i.data('image-src', i.attr('src')),
              ...
              a.hasClass('active')
                ? i.attr('src', a.data('src'))
                : (i.attr('src', i.data('image-src')), a.blur()),
              e.preventDefault();
          }
        );
      },
          ...
          window.pageYOffset > a + i.outerHeight() - window.innerHeight - 150 &&
            ...
            t.ajax({
              ...
              success: function (e) {
                ...
                i.data('load-count', ++o),
                  o > 2 &&
                    window.removeEventListener('scroll', n, { passive: !0 });
              },
              failure: function () {
      ...
      (Wolmart.initQtyInput = function (e) {
        Wolmart.$(e).each(function () {
          ...
          e.data('quantityInput') ||
            e.data('quantityInput', new QuantityInput(e));
        });
      });
  })(jQuery),
  (function (t) {
          ...
          ? (i.close(),
            setTimeout(function () {
              t.magnificPopup.open(
                t.extend(!0, {}, Popup.defaults, a ? Popup.presets[a] : {}, e)
              );
            }, 500))
          : t.magnificPopup.open(
              t.extend(!0, {}, Popup.defaults, a ? Popup.presets[a] : {}, e)
      ...
      o = function (a) {
        a.thumbsIsVertical
          ? (a.$thumbs.hasClass('owl-carousel') &&
              (a.$thumbs.data('owl.carousel').destroy(),
              a.$thumbs.removeClass('owl-carousel')),
            (a.thumbsHeight =
              a.$productThumb[0].offsetHeight * a.thumbsCount +
              parseInt(a.$productThumb.css('margin-bottom')) *
                (a.thumbsCount - 1)),
            a.$thumbUp.addClass('disabled'),
            a.$thumbDown.toggleClass(
              'disabled',
              a.thumbsHeight <= a.$thumbsWrap[0].offsetHeight
            ))
            ...
            a.$thumbs.hasClass('owl-carousel') ||
              a.$thumbs
                ...
                .owlCarousel(
                  t.extend(
                    !0,
                    a.isQuickView ? { onInitialized: n, onResized: n } : {},
                    e
                  )
                ));
      },
    ...
    (ProductSingle.prototype.init = function (e) {
      ...
      (r.$wrapper = e),
            ...
            document.body.classList.contains('home') ||
              ...
              (function (e) {
                (e.$thumbs = e.$wrapper.find('.product-thumbs')),
                  ...
                  (e.thumbsIsVertical =
                    e._isPgVertical && window.innerWidth >= 992),
        ...
        'complete' === Wolmart.status &&
          (Wolmart.slider(l), Wolmart.initQtyInput(e.find('.quantity'))),
        r.$wrapper.find('.product-thumbs-sticky').length &&
          ((r.isStickyScrolling = !1),
          r.$wrapper.on(
            'click',
            '.product-thumb:not(.active)',
            r.clickStickyThumbnail.bind(this)
          ),
          window.addEventListener(
            'scroll',
            r.scrollStickyThumbnail.bind(this),
            { passive: !0 }
          )),
        (function (e) {
      ...
      (ProductSingle.prototype.setThumbsActive = function (t) {
        ...
        if (
          ...
          Wolmart.requestTimeout(function () {
            e.$thumbs.data('owl.carousel') &&
              e.$thumbs.data('owl.carousel').to(t);
          }, 100);
      }),
      (ProductSingle.prototype.variationCheck = function () {
        ...
        this.$selects.each(function () {
          ...
          this.$items.each(function () {
            var a = t(this);
            if (a.children('a:not(.size-guide)').length)
              return a.children('.active').length || (e = !1);
          }),
      ...
      (ProductSingle.prototype.clickStickyThumbnail = function (e) {
        ...
        var n = i
          ...
          .find('.product-image-wrapper > :nth-child(' + o + ')');
  ...
  (function (t) {
    function e(e) {
      ...
      if (
        (a = o.closest('.review-image').length
          ...
          ? n.find(
              '.product-single-carousel .owl-item:not(.cloned) img:first-child'
            )
        ...
        var s = n
            ...
            .data('owl.carousel'),
          r = s
            ? (s.current() - s.clones().length / 2 + i.length) % i.length
            : n.find('.product-gallery > *').index();
    ...
    function i(e) {
      ...
      a.addClass('active').siblings().removeClass('active'),
        ...
        a.closest('.rating-form').find('select').val(a.text()),
        e.preventDefault();
    }
    function o(e) {
      var a = t(this),
      ...
      Wolmart.zoomImage('.product-gallery .product-image'),
        (function (e) {
          ...
          function n() {
            a.hasClass('fix-top') &&
              window.innerWidth > 767 &&
              a.removeClass('fix-top').addClass('fix-bottom'),
              (a.hasClass('fix-bottom') && window.innerWidth > 767) ||
                (a.hasClass('fix-bottom') &&
                  window.innerWidth < 768 &&
                  a.removeClass('fix-bottom').addClass('fix-top'),
                a.hasClass('fix-top') && window.innerWidth);
          }
          a.find('.product-qty-form').before(o),
  ...
  (function (t) {
    var e = function (t) {
      ...
      (e += this.settings.displayYear ? ' ' + t.getFullYear() : ''),
        this.element.find('.calendar-title').html(e);
    };
    (Calendar.defaultOptions = {
      ...
      (Calendar.prototype.render = function (e, a) {
        ...
        for (var u = d; u < d + 7; u++) {
          var p = t(
            '<th>' +
              this.settings.days[u % 7].substring(0, this.settings.dayExcerpt) +
              '</th>'
          );
        ...
        for (var m = l; m < c; m.setDate(m.getDate())) {
          ...
          for (u = 0; u < 7; u++) {
            ...
            m.toDateString() == new Date().toDateString() &&
              f.find('.day').addClass('today'),
              m.getMonth() != e.getMonth() &&
                f.find('.day').addClass('disabled'),
              h.append(f),
      ...
      (Calendar.prototype.changeMonth = function (a) {
        this.today.setMonth(this.today.getMonth() + a, 1),
      ...
      (Wolmart.slideContent = function (e) {
        ...
        a.on('click', function (t) {
          t.preventDefault(),
            i.hasClass('open')
              ? (i.removeClass('open').slideUp(),
                a.find('.custom-checkbox').removeClass('checked'))
              : (i.addClass('open').slideDown(),
                a.find('.custom-checkbox').addClass('checked'));
        });
      }),
      (Wolmart.initLoginVendor = function (e) {
        ...
        a.find('.check-seller').on('click', function () {
          a.find('#check-seller').addClass('active'),
            a.find('#check-customer').removeClass('active'),
            i.slideDown();
        }),
          o.on('click', function () {
            a.find('#check-customer').addClass('active'),
              a.find('#check-seller').removeClass('active'),
              i.slideUp();
          });
      });
  })(jQuery),
  ...
  (Wolmart.prepare = function () {
    Wolmart.$body.hasClass('with-flex-container') &&
